...
//         ctx.fillText(line_1, _x, (_y - 60));
    ...
    setInterval(function(){ 
        ...
        background_color = jQuery("#modern-background-color input").val();
        $("#outer-lineart").css('background-color', background_color );
        $(".street-labels").css('color', font_color );
...
//         cpkDrawCanvas();
   ...
   jQuery("#modern-background-color input").change(function() {
        background_color = jQuery("#modern-background-color input").val();
